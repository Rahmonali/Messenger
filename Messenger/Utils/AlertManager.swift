...
class AlertManager {
    ...
    private static func showBasicAlert(on vc: UIViewController, title: String, message: String?, actionButtonTitle: String = "Dismiss") {
...
extension AlertManager {
    ...
    public static func showRegistrationSuccessAlert(on vc: UIViewController) {
        self.showBasicAlert(on: vc, title: "Account Created", message: "Please log in.", actionButtonTitle: "OK")
    }
